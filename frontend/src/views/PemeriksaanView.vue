                  ...
                  <div class="video-container mb-3">
                    ...
                    <div v-else class="video-wrapper">
                      <div class="video-section">
                        <video v-if="video.rawBlobUrl" :src="video.raw_video_stream_url" controls class="video-stream"></video>
                      </div>
                      <div class="video-section">
                        <video v-if="video.processedBlobUrl" :src="video.processed_video_stream_url" controls
